...
sudo apt-get install git vim zsh htop terminator curl virtualbox vagrant conky vlc chromium-browser flashplugin-installer unity-tweak-tool samba system-config-samba cifs-utils winbind hotot -y
